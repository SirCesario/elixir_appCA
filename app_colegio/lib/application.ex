defmodule AppColegio.Application do
  alias AppColegio.Infrastructure.EntryPoint.ApiRest
  alias AppColegio.Config.{AppConfig, ConfigHolder}
  alias AppColegio.Utils.CertificatesAdmin
  alias AppColegio.Utils.CustomTelemetry
  ...
  def start(_type, _args) do
    ...
    opts = [strategy: :one_for_one, name: AppColegio.Supervisor]
