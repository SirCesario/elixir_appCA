defmodule AppColegio.Infrastructure.EntryPoint.ApiRest do

  @moduledoc """
  Access point to the rest exposed services
  """
  alias AppColegio.Utils.DataTypeUtils
  alias AppColegio.Infrastructure.EntryPoint.ErrorHandler
  require Logger
  use Plug.Router
  use Timex
  ...
  plug(Plug.Telemetry, event_prefix: [:app_colegio, :plug])
  plug(:dispatch)

  forward(
    "/app_colegio/api/health",
    to: PlugCheckup,
    init_opts: PlugCheckup.Options.new(json_encoder: Jason, checks: AppColegio.Infrastructure.EntryPoint.HealthCheck.checks)
  )

  get "/app_colegio/api/hello/" do
