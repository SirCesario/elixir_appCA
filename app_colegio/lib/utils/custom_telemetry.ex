defmodule AppColegio.Utils.CustomTelemetry do
  alias AppColegio.Utils.DataTypeUtils
  import Telemetry.Metrics

  @service_name Application.compile_env!(:app_colegio, :custom_metrics_prefix_name)
  ...
  def custom_telemetry_events() do
    :telemetry.attach("app_colegio-plug-stop", [:app_colegio, :plug, :stop], &handle_custom_event/4, nil)
    :telemetry.attach("app_colegio-redis-stop", [:redix, :pipeline, :stop], &handle_custom_event/4, nil)
    :telemetry.attach("app_colegio-vm-memory", [:vm, :memory], &handle_custom_event/4, nil)
  ...
  def handle_custom_event([:app_colegio, :plug, :stop], measures, metadata, _) do
    :telemetry.execute(
